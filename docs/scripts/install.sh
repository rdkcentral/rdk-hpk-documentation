...
clone_repo "https://github.com/rdkcentral/rdk-halif-rmf_audio_capture.git" "${EXTERNAL_CONTENT_DIR}/rmf_audio_capture" "1.0.6"
clone_repo "https://github.com/rdkcentral/rdk-halif-test-rmf_audio_capture.git" "${EXTERNAL_CONTENT_DIR}/rmf_audio_capture_test" "1.5.4"
clone_repo "https://github.com/rdkcentral/rdk-halif-power_manager.git" "${EXTERNAL_CONTENT_DIR}/power_manager" "1.0.4"
clone_repo "https://github.com/rdkcentral/rdk-halif-test-power_manager.git" "${EXTERNAL_CONTENT_DIR}/power_manager_test" "1.5.4"
clone_repo "https://github.com/rdkcentral/rdk-halif-deepsleep_manager.git" "${EXTERNAL_CONTENT_DIR}/deepsleep_manager" "1.0.5"
clone_repo "https://github.com/rdkcentral/rdk-halif-test-deepsleep_manager.git" "${EXTERNAL_CONTENT_DIR}/deepsleep_manager_test" "1.4.3"
clone_repo "https://github.com/rdkcentral/rdk-halif-device_settings.git" "${EXTERNAL_CONTENT_DIR}/device_settings" "6.0.1"
clone_repo "https://github.com/rdkcentral/rdk-halif-test-device_settings.git" "${EXTERNAL_CONTENT_DIR}/device_settings_test" "6.0.1"
clone_repo "https://github.com/rdkcentral/rdk-halif-hdmi_cec.git" "${EXTERNAL_CONTENT_DIR}/hdmi_cec" "1.4.0"
clone_repo "https://github.com/rdkcentral/rdk-halif-test-hdmi_cec.git" "${EXTERNAL_CONTENT_DIR}/hdmi_cec_test" "1.6.1"
clone_repo "https://github.com/rdkcentral/rdkv-halif-tvsettings.git" "${EXTERNAL_CONTENT_DIR}/tvsettings" "2.4.0"
clone_repo "https://github.com/rdkcentral/rdkv-halif-test-tvsettings.git" "${EXTERNAL_CONTENT_DIR}/tvsettings_test" "2.3.2"
clone_repo "https://github.com/rdkcentral/rdk-halif-test-initial-setup.git" "${EXTERNAL_CONTENT_DIR}/initial_setup_test" "1.0.1"
