...
|SNo|Component Name|HAL Interface (HALIF) Documentation|L1 HAL Interface Test (HALIF TEST) Documentation|
|---|--------------|-----------------|-------------------------|
...
|6|[`RDK-V` WiFi](https://github.com/rdkcentral/rdkv-halif-wifi)|[2.0.0](https://github.com/rdkcentral/rdkv-halif-wifi/blob/2.0.0)|Yet to be released|
|7|[LibDRM](https://github.com/rdkcentral/rdk-halif-libdrm)|[1.0.0](https://github.com/rdkcentral/rdk-halif-libdrm/blob/1.0.0)|Yet to be released|
|8|[AvSync](https://github.com/rdkcentral/rdk-halif-avsync)|[1.0.0](https://github.com/rdkcentral/rdk-halif-avsync/blob/1.0.0)|Yet to be released|
